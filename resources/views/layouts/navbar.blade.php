    ...
    <div class="topbar-container h-full">
        <div class="flex justify-between items-center h-full">
            ...
            <div class="flex items-center space-x-2.5">
                ...
                <div class="flex items-center space-x-2.5">
                    <a href="https://www.facebook.com/adventurecodebusiness/" class="topbar-link">
                    ...
                    <a href="https://www.instagram.com/advnturecode/?next=%2Fapexautopartsusa%2F" class="topbar-link">
                        <svg class="w-3 h-3" fill="currentColor" viewBox="0 0 24 24"><path d="M7.5 2h9A5.5 5.5 0 0 1 22 7.5v9A5.5 5.5 0 0 1 16.5 22h-9A5.5 5.5 0 0 1 2 16.5v-9A5.5 5.5 0 0 1 7.5 2Zm0 2A3.5 3.5 0 0 0 4 7.5v9A3.5 3.5 0 0 0 7.5 20h9a3.5 3.5 0 0 0 3.5-3.5v-9A3.5 3.5 0 0 0 16.5 4h-9Zm10.25 1.75a1 1 0 1 1 0 2 1 1 0 0 1 0-2ZM12 7a5 5 0 1 1 0 10 5 5 0 0 1 0-10Zm0 2a3 3 0 1 0 0 6 3 3 0 0 0 0-6Z"/></svg>
                    </a>
                    <a href="https://www.linkedin.com/company/adventure-code-business/posts/?feedView=all" class="topbar-link">
