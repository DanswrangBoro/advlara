        ...
        <div class="py-12 sm:py-16 lg:py-20">
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-12 gap-8 lg:gap-12">
                ...
                <div class="lg:col-span-4">
                    ...
                    <div>
                        ...
                        <div class="flex flex-wrap gap-3">
                            <a href="https://www.facebook.com/adventurecodebusiness/" class="social-icon-shine w-12 h-12 bg-gradient-to-br from-blue-500 to-blue-600 flex items-center justify-center text-white hover:scale-110 hover:-translate-y-1 transition-all duration-300">
                            ...
                            <a href="https://www.linkedin.com/company/adventure-code-business/posts/?feedView=all" class="social-icon-shine w-12 h-12 bg-gradient-to-br from-blue-600 to-blue-700 flex items-center justify-center text-white hover:scale-110 hover:-translate-y-1 transition-all duration-300">
                            ...
                            <a href="https://www.instagram.com/advnturecode/?next=%2Fapexautopartsusa%2F" class="social-icon-shine w-12 h-12 bg-gradient-to-br from-pink-500 to-orange-500 flex items-center justify-center text-white hover:scale-110 hover:-translate-y-1 transition-all duration-300">
                ...
                <div class="lg:col-span-2">
                    ...
                    <ul class="space-y-3">
                        <li><a href="{{ route('home') }}" class="text-sm text-gray-700 hover:text-blue-600 hover:translate-x-2 transition-all duration-300 flex items-center group font-medium">
                            <span class="w-0 h-0.5 bg-blue-600 group-hover:w-5 mr-0 group-hover:mr-2 transition-all duration-300"></span>
                            Home
                        </a></li>
                        <li><a href="{{ route('about') }}" class="text-sm text-gray-700 hover:text-blue-600 hover:translate-x-2 transition-all duration-300 flex items-center group font-medium">
                            <span class="w-0 h-0.5 bg-blue-600 group-hover:w-5 mr-0 group-hover:mr-2 transition-all duration-300"></span>
                            About Us
                        </a></li>
                        <li><a href="{{ route('home') }}#services-section" class="text-sm text-gray-700 hover:text-blue-600 hover:translate-x-2 transition-all duration-300 flex items-center group font-medium">
                            <span class="w-0 h-0.5 bg-blue-600 group-hover:w-5 mr-0 group-hover:mr-2 transition-all duration-300"></span>
                            Services
                        </a></li>
                        <li><a href="{{ route('contact_us') }}" class="text-sm text-gray-700 hover:text-blue-600 hover:translate-x-2 transition-all duration-300 flex items-center group font-medium">
                            <span class="w-0 h-0.5 bg-blue-600 group-hover:w-5 mr-0 group-hover:mr-2 transition-all duration-300"></span>
                            Contact
                        </a></li>
                    </ul>
                ...
                <div class="lg:col-span-2">
                    ...
                    <ul class="space-y-3">
                        <li><a href="{{ route('web_development') }}" class="text-sm text-gray-700 hover:text-orange-600 hover:translate-x-2 transition-all duration-300 flex items-center group font-medium">
                            <span class="w-0 h-0.5 bg-orange-500 group-hover:w-5 mr-0 group-hover:mr-2 transition-all duration-300"></span>
                            Web Development
                        </a></li>
                        <li><a href="{{ route('digital_marketing') }}" class="text-sm text-gray-700 hover:text-orange-600 hover:translate-x-2 transition-all duration-300 flex items-center group font-medium">
                            <span class="w-0 h-0.5 bg-orange-500 group-hover:w-5 mr-0 group-hover:mr-2 transition-all duration-300"></span>
                            Digital Marketing
                        </a></li>
                        <li><a href="{{ route('seo') }}" class="text-sm text-gray-700 hover:text-orange-600 hover:translate-x-2 transition-all duration-300 flex items-center group font-medium">
                            <span class="w-0 h-0.5 bg-orange-500 group-hover:w-5 mr-0 group-hover:mr-2 transition-all duration-300"></span>
                            SEO Services
                        </a></li>
                        <li><a href="{{ route('graphic_design') }}" class="text-sm text-gray-700 hover:text-orange-600 hover:translate-x-2 transition-all duration-300 flex items-center group font-medium">
                            <span class="w-0 h-0.5 bg-orange-500 group-hover:w-5 mr-0 group-hover:mr-2 transition-all duration-300"></span>
                            Graphic Design
                        </a></li>
                        <li><a href="{{ route('travel_solution') }}" class="text-sm text-gray-700 hover:text-orange-600 hover:translate-x-2 transition-all duration-300 flex items-center group font-medium">
                            <span class="w-0 h-0.5 bg-orange-500 group-hover:w-5 mr-0 group-hover:mr-2 transition-all duration-300"></span>
                            Travel Solutions
                        </a></li>
                        <li><a href="{{ route('app_development') }}" class="text-sm text-gray-700 hover:text-orange-600 hover:translate-x-2 transition-all duration-300 flex items-center group font-medium">
                            <span class="w-0 h-0.5 bg-orange-500 group-hover:w-5 mr-0 group-hover:mr-2 transition-all duration-300"></span>
                            App Development
                        </a></li>
                    </ul>
        ...
        <div class="py-8">
            ...
            <div class="flex flex-col sm:flex-row justify-between items-center gap-4">
                <p class="text-sm text-gray-600">
                    © 2026 <span class="font-black text-gray-900">AdventureCode</span>. All rights reserved.
                </p>
                
                <div class="flex flex-wrap items-center justify-center gap-6">
                    <a href="{{ route('privacy') }}" class="text-sm text-gray-600 hover:text-blue-600 font-bold transition-colors">
                        Privacy Policy
                    </a>
                    <a href="{{ route('terms') }}" class="text-sm text-gray-600 hover:text-blue-600 font-bold transition-colors">
                        Terms of Service
                    </a>
                </div>
            </div>
